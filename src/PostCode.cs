...
//  Altered - 14/10/2020 11:13 - Stephen Ellwood
// 
//  Project : - NLC.Library
// 
//  </summary>
...
namespace NLC.Library
    {
        ...
        ///     N = numerical value
        /// </remarks>
        public sealed class PostCode : IPostCode, IEquatable<PostCode>
            {
                ...
                /// </summary>
                /// <value>
                ///     Flag to indicate if the post code is an unknown one or not, equvalent to UK validity
                /// </value>
                public bool Unknown
                {
                    get => !IsUkValid();
                ...
                ///     <paramref name="x" /> and <paramref name="y" /> are of different types and
                ///     neither one can handle comparisons with the other.
                /// </exception>
                public new bool Equals(object x,
                    object y)
                    {
                        if (!(x is string pCode1) || !(y is string pCode2))
                            {
                                return false;
                            }

                        return pCode1 == pCode2;
                    }
                ...
                /// </returns>
                /// <param name="obj">get value of Object obj and convert to string before returning it</param>
                ...
                public int GetHashCode(object obj)
                    {
                        var pCode = obj as string;

                        return pCode.GetHashCode();
                    }
                ...
                /// <param name="rhs"></param>
                /// <returns></returns>
                public static bool operator !=(PostCode lhs, PostCode rhs) => !(lhs == rhs);

                #region Implementation of IEquatable<Ipostcode>

                /// <inheritdoc />
                public bool Equals(IPostCode other) => Equals(other as PostCode);

                /// <summary>
                /// </summary>
                /// <param name="postcode"></param>
                /// <returns></returns>
                public override bool Equals(object postcode) => Equals(postcode as PostCode);
